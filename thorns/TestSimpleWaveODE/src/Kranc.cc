...
void TestSimpleWaveODE_TiledLoop(
...
void TestSimpleWaveODE_TiledLoopOverEverything(
  cGH const * restrict const cctkGH,
  void (calc)(const cGH* restrict const cctkGH,
              const KrancData & restrict kd))
{
  ...
  TestSimpleWaveODE_TiledLoop(cctkGH, kd_coarse, calc);
}

void TestSimpleWaveODE_TiledLoopOverInterior(
  cGH const * restrict const cctkGH,
  void (calc)(const cGH* restrict const cctkGH,
              const KrancData & restrict kd))
{
