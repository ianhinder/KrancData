...
extern "C" void TestSimpleWaveODE_CalcRHS(CCTK_ARGUMENTS)
{
  ...
  GenericFD_AssertGroupStorage(cctkGH, "TestSimpleWaveODE_CalcRHS", 2, groups);
  
  GenericFD_EnsureStencilFits(cctkGH, "TestSimpleWaveODE_CalcRHS", 1, 1, 1);
  
  GenericFD_LoopOverInterior(cctkGH, TestSimpleWaveODE_CalcRHS_Body);
  if (verbose > 1)
  {
