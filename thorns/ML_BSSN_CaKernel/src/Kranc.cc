...
void ML_BSSN_CaKernel_TiledLoop(
...
void ML_BSSN_CaKernel_TiledLoopOverEverything(
  cGH const * restrict const cctkGH,
  void (calc)(const cGH* restrict const cctkGH,
              const KrancData & restrict kd))
{
  ...
  ML_BSSN_CaKernel_TiledLoop(cctkGH, kd_coarse, calc);
}

void ML_BSSN_CaKernel_TiledLoopOverInterior(
  cGH const * restrict const cctkGH,
  void (calc)(const cGH* restrict const cctkGH,
              const KrancData & restrict kd))
{
