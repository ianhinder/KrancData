...
extern "C" void TestSimpleWaveVectors_CheckBoundaries(CCTK_ARGUMENTS)
{
...
extern "C" void TestSimpleWaveVectors_SelectBoundConds(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
      ...
      CCTK_EQUALS(evolved_group_bound, "zero"  ) )
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "TestSimpleWaveVectors::evolved_group", evolved_group_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register evolved_group_bound BC for TestSimpleWaveVectors::evolved_group!");
  }
      ...
      CCTK_EQUALS(phi_bound, "zero"  ) )
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "TestSimpleWaveVectors::phi", phi_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register phi_bound BC for TestSimpleWaveVectors::phi!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "TestSimpleWaveVectors::pi", pi_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register pi_bound BC for TestSimpleWaveVectors::pi!");
  }
  ...
  if (CCTK_EQUALS(evolved_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_evolved_group_bound, 
                      "TestSimpleWaveVectors::evolved_group", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for TestSimpleWaveVectors::evolved_group!");
  ...
  if (CCTK_EQUALS(phi_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phi_bound, 
                      "TestSimpleWaveVectors::phi", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for TestSimpleWaveVectors::phi!");
  ...
  if (CCTK_EQUALS(pi_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_pi_bound, 
                      "TestSimpleWaveVectors::pi", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for TestSimpleWaveVectors::pi!");
  ...
  if (CCTK_EQUALS(evolved_group_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_evolved_group_bound, 
                      "TestSimpleWaveVectors::evolved_group", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for TestSimpleWaveVectors::evolved_group!");
  ...
  if (CCTK_EQUALS(phi_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phi_bound, 
                      "TestSimpleWaveVectors::phi", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for TestSimpleWaveVectors::phi!");
  ...
  if (CCTK_EQUALS(pi_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_pi_bound, 
                      "TestSimpleWaveVectors::pi", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for TestSimpleWaveVectors::pi!");
...
#$bound$#TestSimpleWaveVectors::evolved_group_bound       = "skip"
#$bound$#TestSimpleWaveVectors::evolved_group_bound_speed = 1.0
#$bound$#TestSimpleWaveVectors::evolved_group_bound_limit = 0.0
#$bound$#TestSimpleWaveVectors::evolved_group_bound_scalar = 0.0

#$bound$#TestSimpleWaveVectors::phi_bound       = "skip"
#$bound$#TestSimpleWaveVectors::phi_bound_speed = 1.0
#$bound$#TestSimpleWaveVectors::phi_bound_limit = 0.0
#$bound$#TestSimpleWaveVectors::phi_bound_scalar = 0.0

#$bound$#TestSimpleWaveVectors::pi_bound       = "skip"
#$bound$#TestSimpleWaveVectors::pi_bound_speed = 1.0
#$bound$#TestSimpleWaveVectors::pi_bound_limit = 0.0
#$bound$#TestSimpleWaveVectors::pi_bound_scalar = 0.0
