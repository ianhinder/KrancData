...
void TestSimpleWaveVectors_TiledLoop(
...
void TestSimpleWaveVectors_TiledLoopOverEverything(
  cGH const * restrict const cctkGH,
  void (calc)(const cGH* restrict const cctkGH,
              const KrancData & restrict kd))
{
  ...
  TestSimpleWaveVectors_TiledLoop(cctkGH, kd_coarse, calc);
}

void TestSimpleWaveVectors_TiledLoopOverInterior(
  cGH const * restrict const cctkGH,
  void (calc)(const cGH* restrict const cctkGH,
              const KrancData & restrict kd))
{
