...
extern "C" void ML_BSSN_OpenCL_constraints1_SelectBCs(CCTK_ARGUMENTS)
{
  ...
  if (cctk_iteration % ML_BSSN_OpenCL_constraints1_calc_every != ML_BSSN_OpenCL_constraints1_calc_offset)
    return;
  CCTK_INT ierr CCTK_ATTRIBUTE_UNUSED = 0;
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_BSSN_OpenCL::ML_Ham","flat");
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for ML_BSSN_OpenCL::ML_Ham.");
  return;
}

static void ML_BSSN_OpenCL_constraints1_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  "#pragma omp parallel\n"
  "CCTK_LOOP3STR(ML_BSSN_OpenCL_constraints1,\n"
  ...
  "}\n"
  "CCTK_ENDLOOP3STR(ML_BSSN_OpenCL_constraints1);\n"
  ""
  ;
  ...
  OpenCLRunTime_CallKernel(cctkGH, CCTK_THORNSTRING, "ML_BSSN_OpenCL_constraints1",
                           sources, groups, NULL, NULL, NULL, -1,
                           imin, imax, &kernel);
  
}
extern "C" void ML_BSSN_OpenCL_constraints1(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering ML_BSSN_OpenCL_constraints1_Body");
  }
  if (cctk_iteration % ML_BSSN_OpenCL_constraints1_calc_every != ML_BSSN_OpenCL_constraints1_calc_offset)
  {
    return;
  ...
  const char* const groups[] = {
    ...
    "ML_BSSN_OpenCL::ML_shift",
    "ML_BSSN_OpenCL::ML_trace_curv"};
  AssertGroupStorage(cctkGH, "ML_BSSN_OpenCL_constraints1", 8, groups);
  
  switch (fdOrder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "ML_BSSN_OpenCL_constraints1", 1, 1, 1);
      break;
    }
    
    case 4:
    {
      EnsureStencilFits(cctkGH, "ML_BSSN_OpenCL_constraints1", 2, 2, 2);
      break;
    }
    default:
      CCTK_BUILTIN_UNREACHABLE();
  ...
  LoopOverInterior(cctkGH, ML_BSSN_OpenCL_constraints1_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving ML_BSSN_OpenCL_constraints1_Body");
  }
}
