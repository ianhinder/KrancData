...
extern "C" void ML_BSSN_OpenCL_RHS2(CCTK_ARGUMENTS)
{
  ...
  const char* const groups[] = {
    ...
    "ML_BSSN_OpenCL::ML_shift",
    "ML_BSSN_OpenCL::ML_trace_curv"};
  AssertGroupStorage(cctkGH, "ML_BSSN_OpenCL_RHS2", 8, groups);
  
  switch (fdOrder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "ML_BSSN_OpenCL_RHS2", 1, 1, 1);
      break;
    }
    
    case 4:
    {
      EnsureStencilFits(cctkGH, "ML_BSSN_OpenCL_RHS2", 2, 2, 2);
      break;
    }
    default:
      CCTK_BUILTIN_UNREACHABLE();
  ...
  LoopOverInterior(cctkGH, ML_BSSN_OpenCL_RHS2_Body);
  if (verbose > 1)
  {
