...
static void eulerauto_cons_calc_zero_rhs_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL DenrhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    DenrhsL = 0;
    
    DenrhsL = 0;
    
    CCTK_REAL S1rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL S2rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL S3rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    ...
    CCTK_REAL EnrhsL CCTK_ATTRIBUTE_UNUSED = 0;
...
extern "C" void eulerauto_cons_calc_zero_rhs(CCTK_ARGUMENTS)
{
  ...
  AssertGroupStorage(cctkGH, "eulerauto_cons_calc_zero_rhs", 3, groups);
  
  
  LoopOverEverything(cctkGH, eulerauto_cons_calc_zero_rhs_Body);
  if (verbose > 1)
  {
