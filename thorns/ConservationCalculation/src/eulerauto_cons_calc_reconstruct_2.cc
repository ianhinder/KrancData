...
extern "C" void eulerauto_cons_calc_reconstruct_2(CCTK_ARGUMENTS)
{
  ...
  AssertGroupStorage(cctkGH, "eulerauto_cons_calc_reconstruct_2", 8, groups);
  
  EnsureStencilFits(cctkGH, "eulerauto_cons_calc_reconstruct_2", 1, 1, 1);
  
  LoopOverInterior(cctkGH, eulerauto_cons_calc_reconstruct_2_Body);
  if (verbose > 1)
  {
