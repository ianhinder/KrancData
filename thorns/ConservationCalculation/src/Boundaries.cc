...
extern "C" void ConservationCalculation_CheckBoundaries(CCTK_ARGUMENTS)
{
...
extern "C" void ConservationCalculation_SelectBoundConds(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
      ...
      CCTK_EQUALS(Den_group_bound, "zero"  ) )
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ConservationCalculation::Den_group", Den_group_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Den_group_bound BC for ConservationCalculation::Den_group!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ConservationCalculation::S_group", S_group_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register S_group_bound BC for ConservationCalculation::S_group!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ConservationCalculation::En_group", En_group_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register En_group_bound BC for ConservationCalculation::En_group!");
  }
      ...
      CCTK_EQUALS(Den_bound, "zero"  ) )
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ConservationCalculation::Den", Den_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Den_bound BC for ConservationCalculation::Den!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ConservationCalculation::S1", S1_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register S1_bound BC for ConservationCalculation::S1!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ConservationCalculation::S2", S2_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register S2_bound BC for ConservationCalculation::S2!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ConservationCalculation::S3", S3_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register S3_bound BC for ConservationCalculation::S3!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ConservationCalculation::En", En_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register En_bound BC for ConservationCalculation::En!");
  }
  ...
  if (CCTK_EQUALS(Den_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Den_group_bound, 
                      "ConservationCalculation::Den_group", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ConservationCalculation::Den_group!");
  ...
  if (CCTK_EQUALS(S_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_S_group_bound, 
                      "ConservationCalculation::S_group", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ConservationCalculation::S_group!");
  ...
  if (CCTK_EQUALS(En_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_En_group_bound, 
                      "ConservationCalculation::En_group", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ConservationCalculation::En_group!");
  ...
  if (CCTK_EQUALS(Den_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Den_bound, 
                      "ConservationCalculation::Den", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ConservationCalculation::Den!");
  ...
  if (CCTK_EQUALS(S1_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_S1_bound, 
                      "ConservationCalculation::S1", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ConservationCalculation::S1!");
  ...
  if (CCTK_EQUALS(S2_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_S2_bound, 
                      "ConservationCalculation::S2", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ConservationCalculation::S2!");
  ...
  if (CCTK_EQUALS(S3_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_S3_bound, 
                      "ConservationCalculation::S3", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ConservationCalculation::S3!");
  ...
  if (CCTK_EQUALS(En_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_En_bound, 
                      "ConservationCalculation::En", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ConservationCalculation::En!");
  ...
  if (CCTK_EQUALS(Den_group_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Den_group_bound, 
                      "ConservationCalculation::Den_group", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for ConservationCalculation::Den_group!");
  ...
  if (CCTK_EQUALS(S_group_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_S_group_bound, 
                      "ConservationCalculation::S_group", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for ConservationCalculation::S_group!");
  ...
  if (CCTK_EQUALS(En_group_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_En_group_bound, 
                      "ConservationCalculation::En_group", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for ConservationCalculation::En_group!");
  ...
  if (CCTK_EQUALS(Den_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Den_bound, 
                      "ConservationCalculation::Den", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ConservationCalculation::Den!");
  ...
  if (CCTK_EQUALS(S1_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_S1_bound, 
                      "ConservationCalculation::S1", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ConservationCalculation::S1!");
  ...
  if (CCTK_EQUALS(S2_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_S2_bound, 
                      "ConservationCalculation::S2", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ConservationCalculation::S2!");
  ...
  if (CCTK_EQUALS(S3_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_S3_bound, 
                      "ConservationCalculation::S3", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ConservationCalculation::S3!");
  ...
  if (CCTK_EQUALS(En_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_En_bound, 
                      "ConservationCalculation::En", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ConservationCalculation::En!");
...
#$bound$#ConservationCalculation::Den_group_bound       = "skip"
#$bound$#ConservationCalculation::Den_group_bound_speed = 1.0
#$bound$#ConservationCalculation::Den_group_bound_limit = 0.0
#$bound$#ConservationCalculation::Den_group_bound_scalar = 0.0

#$bound$#ConservationCalculation::S_group_bound       = "skip"
#$bound$#ConservationCalculation::S_group_bound_speed = 1.0
#$bound$#ConservationCalculation::S_group_bound_limit = 0.0
#$bound$#ConservationCalculation::S_group_bound_scalar = 0.0

#$bound$#ConservationCalculation::En_group_bound       = "skip"
#$bound$#ConservationCalculation::En_group_bound_speed = 1.0
#$bound$#ConservationCalculation::En_group_bound_limit = 0.0
#$bound$#ConservationCalculation::En_group_bound_scalar = 0.0

#$bound$#ConservationCalculation::Den_bound       = "skip"
#$bound$#ConservationCalculation::Den_bound_speed = 1.0
#$bound$#ConservationCalculation::Den_bound_limit = 0.0
#$bound$#ConservationCalculation::Den_bound_scalar = 0.0

#$bound$#ConservationCalculation::S1_bound       = "skip"
#$bound$#ConservationCalculation::S1_bound_speed = 1.0
#$bound$#ConservationCalculation::S1_bound_limit = 0.0
#$bound$#ConservationCalculation::S1_bound_scalar = 0.0

#$bound$#ConservationCalculation::S2_bound       = "skip"
#$bound$#ConservationCalculation::S2_bound_speed = 1.0
#$bound$#ConservationCalculation::S2_bound_limit = 0.0
#$bound$#ConservationCalculation::S2_bound_scalar = 0.0

#$bound$#ConservationCalculation::S3_bound       = "skip"
#$bound$#ConservationCalculation::S3_bound_speed = 1.0
#$bound$#ConservationCalculation::S3_bound_limit = 0.0
#$bound$#ConservationCalculation::S3_bound_scalar = 0.0

#$bound$#ConservationCalculation::En_bound       = "skip"
#$bound$#ConservationCalculation::En_bound_speed = 1.0
#$bound$#ConservationCalculation::En_bound_limit = 0.0
#$bound$#ConservationCalculation::En_bound_scalar = 0.0
