...
void ConservationCalculation_TiledLoop(
...
void ConservationCalculation_TiledLoopOverEverything(
  cGH const * restrict const cctkGH,
  void (calc)(const cGH* restrict const cctkGH,
              const KrancData & restrict kd))
{
  ...
  ConservationCalculation_TiledLoop(cctkGH, kd_coarse, calc);
}

void ConservationCalculation_TiledLoopOverInterior(
  cGH const * restrict const cctkGH,
  void (calc)(const cGH* restrict const cctkGH,
              const KrancData & restrict kd))
{
