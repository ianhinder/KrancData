...
static void eulerauto_cons_calc_flux_3_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    const CCTK_REAL ShiftMinus3EnRight CCTK_ATTRIBUTE_UNUSED = ShiftMinus3(&EnRight[index]);
    const CCTK_REAL ShiftMinus3pRight CCTK_ATTRIBUTE_UNUSED = ShiftMinus3(&pRight[index]);
    ...
    const CCTK_REAL ShiftMinus3v1Right CCTK_ATTRIBUTE_UNUSED = ShiftMinus3(&v1Right[index]);
    const CCTK_REAL ShiftMinus3v2Right CCTK_ATTRIBUTE_UNUSED = ShiftMinus3(&v2Right[index]);
    const CCTK_REAL ShiftMinus3v3Right CCTK_ATTRIBUTE_UNUSED = ShiftMinus3(&v3Right[index]);
    /* Calculate temporaries and grid functions */
    CCTK_REAL DenFluxLeft CCTK_ATTRIBUTE_UNUSED = rhoLeftL*v3LeftL;
    ...
    CCTK_REAL S3FluxLeft CCTK_ATTRIBUTE_UNUSED = pLeftL + 
      rhoLeftL*pow(v3LeftL,2);
    
    CCTK_REAL S3FluxRight CCTK_ATTRIBUTE_UNUSED = ShiftMinus3pRight + 
      ShiftMinus3rhoRight*pow(ShiftMinus3v3Right,2);
    ...
    CCTK_REAL EnFluxRight CCTK_ATTRIBUTE_UNUSED = (ShiftMinus3EnRight + 
...
extern "C" void eulerauto_cons_calc_flux_3(CCTK_ARGUMENTS)
{
  ...
  AssertGroupStorage(cctkGH, "eulerauto_cons_calc_flux_3", 15, groups);
  
  EnsureStencilFits(cctkGH, "eulerauto_cons_calc_flux_3", 1, 1, 1);
  
  LoopOverInterior(cctkGH, eulerauto_cons_calc_flux_3_Body);
  if (verbose > 1)
  {
