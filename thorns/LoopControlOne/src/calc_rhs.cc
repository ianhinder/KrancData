...
extern "C" void calc_rhs_SelectBCs(CCTK_ARGUMENTS)
{
  ...
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "LoopControlOne::evolved_grouprhs","flat");
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for LoopControlOne::evolved_grouprhs.");
  return;
}
...
extern "C" void calc_rhs(CCTK_ARGUMENTS)
{
  ...
  const char* const groups[] = {
    "LoopControlOne::evolved_group",
    "LoopControlOne::evolved_grouprhs"};
