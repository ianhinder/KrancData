...
extern "C" void calc_rhs_SelectBCs(CCTK_ARGUMENTS)
{
  ...
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "LoopControlAll::evolved_grouprhs","flat");
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for LoopControlAll::evolved_grouprhs.");
  return;
}
...
extern "C" void calc_rhs(CCTK_ARGUMENTS)
{
  ...
  const char* const groups[] = {
    "LoopControlAll::evolved_group",
    "LoopControlAll::evolved_grouprhs"};
