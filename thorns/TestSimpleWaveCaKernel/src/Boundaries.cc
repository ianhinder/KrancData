...
extern "C" void TestSimpleWaveCaKernel_CheckBoundaries(CCTK_ARGUMENTS)
{
...
extern "C" void TestSimpleWaveCaKernel_SelectBoundConds(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
      ...
      CCTK_EQUALS(evolved_group_bound, "zero"  ) )
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "TestSimpleWaveCaKernel::evolved_group", evolved_group_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register evolved_group_bound BC for TestSimpleWaveCaKernel::evolved_group!");
  }
      ...
      CCTK_EQUALS(phi_bound, "zero"  ) )
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "TestSimpleWaveCaKernel::phi", phi_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register phi_bound BC for TestSimpleWaveCaKernel::phi!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "TestSimpleWaveCaKernel::pi", pi_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register pi_bound BC for TestSimpleWaveCaKernel::pi!");
  }
  ...
  if (CCTK_EQUALS(evolved_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_evolved_group_bound, 
                      "TestSimpleWaveCaKernel::evolved_group", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for TestSimpleWaveCaKernel::evolved_group!");
  ...
  if (CCTK_EQUALS(phi_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phi_bound, 
                      "TestSimpleWaveCaKernel::phi", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for TestSimpleWaveCaKernel::phi!");
  ...
  if (CCTK_EQUALS(pi_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_pi_bound, 
                      "TestSimpleWaveCaKernel::pi", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for TestSimpleWaveCaKernel::pi!");
  ...
  if (CCTK_EQUALS(evolved_group_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_evolved_group_bound, 
                      "TestSimpleWaveCaKernel::evolved_group", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for TestSimpleWaveCaKernel::evolved_group!");
  ...
  if (CCTK_EQUALS(phi_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phi_bound, 
                      "TestSimpleWaveCaKernel::phi", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for TestSimpleWaveCaKernel::phi!");
  ...
  if (CCTK_EQUALS(pi_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_pi_bound, 
                      "TestSimpleWaveCaKernel::pi", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for TestSimpleWaveCaKernel::pi!");
...
#$bound$#TestSimpleWaveCaKernel::evolved_group_bound       = "skip"
#$bound$#TestSimpleWaveCaKernel::evolved_group_bound_speed = 1.0
#$bound$#TestSimpleWaveCaKernel::evolved_group_bound_limit = 0.0
#$bound$#TestSimpleWaveCaKernel::evolved_group_bound_scalar = 0.0

#$bound$#TestSimpleWaveCaKernel::phi_bound       = "skip"
#$bound$#TestSimpleWaveCaKernel::phi_bound_speed = 1.0
#$bound$#TestSimpleWaveCaKernel::phi_bound_limit = 0.0
#$bound$#TestSimpleWaveCaKernel::phi_bound_scalar = 0.0

#$bound$#TestSimpleWaveCaKernel::pi_bound       = "skip"
#$bound$#TestSimpleWaveCaKernel::pi_bound_speed = 1.0
#$bound$#TestSimpleWaveCaKernel::pi_bound_limit = 0.0
#$bound$#TestSimpleWaveCaKernel::pi_bound_scalar = 0.0
