...
extern "C" void ML_BSSN_OpenCL_RHS2_SelectBCs(CCTK_ARGUMENTS)
{
...
static void ML_BSSN_OpenCL_RHS2_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  "CCTK_LOOP3STR(ML_BSSN_OpenCL_RHS2,\n"
  ...
  "}\n"
  "CCTK_ENDLOOP3STR(ML_BSSN_OpenCL_RHS2);\n"
  ""
  ;
  ...
  OpenCLRunTime_CallKernel(cctkGH, CCTK_THORNSTRING, "ML_BSSN_OpenCL_RHS2",
...
extern "C" void ML_BSSN_OpenCL_RHS2(CCTK_ARGUMENTS)
{
  ...
  const char* const groups[] = {
    ...
    "ML_BSSN_OpenCL::ML_shift",
    "ML_BSSN_OpenCL::ML_trace_curv"};
  GenericFD_AssertGroupStorage(cctkGH, "ML_BSSN_OpenCL_RHS2", 8, groups);
  
  switch (fdOrder)
  {
    case 2:
    {
      GenericFD_EnsureStencilFits(cctkGH, "ML_BSSN_OpenCL_RHS2", 1, 1, 1);
      break;
    }
    
    case 4:
    {
      GenericFD_EnsureStencilFits(cctkGH, "ML_BSSN_OpenCL_RHS2", 2, 2, 2);
      break;
    }
    default:
      CCTK_BUILTIN_UNREACHABLE();
