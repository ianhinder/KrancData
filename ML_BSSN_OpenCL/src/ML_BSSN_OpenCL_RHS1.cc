...
extern "C" void ML_BSSN_OpenCL_RHS1(CCTK_ARGUMENTS)
{
  ...
  const char* const groups[] = {
    ...
    "ML_BSSN_OpenCL::ML_trace_curv",
    "ML_BSSN_OpenCL::ML_trace_curvrhs"};
  GenericFD_AssertGroupStorage(cctkGH, "ML_BSSN_OpenCL_RHS1", 18, groups);
  
  switch (fdOrder)
  {
    case 2:
    {
      GenericFD_EnsureStencilFits(cctkGH, "ML_BSSN_OpenCL_RHS1", 1, 1, 1);
      break;
    }
    
    case 4:
    {
      GenericFD_EnsureStencilFits(cctkGH, "ML_BSSN_OpenCL_RHS1", 2, 2, 2);
      break;
    }
    default:
      CCTK_BUILTIN_UNREACHABLE();
  ...
  GenericFD_LoopOverInterior(cctkGH, ML_BSSN_OpenCL_RHS1_Body);
