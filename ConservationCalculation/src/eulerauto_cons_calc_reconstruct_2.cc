...
static void eulerauto_cons_calc_reconstruct_2_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    const CCTK_REAL DiffPlus2p CCTK_ATTRIBUTE_UNUSED = DiffPlus2(&p[index]);
    const CCTK_REAL DiffMinus2p CCTK_ATTRIBUTE_UNUSED = DiffMinus2(&p[index]);
