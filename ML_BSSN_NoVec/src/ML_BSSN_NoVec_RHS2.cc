...
extern "C" void ML_BSSN_NoVec_RHS2(CCTK_ARGUMENTS)
{
  ...
  GenericFD_AssertGroupStorage(cctkGH, "ML_BSSN_NoVec_RHS2", 8, groups);
  
  switch (fdOrder)
  {
    case 2:
    {
      GenericFD_EnsureStencilFits(cctkGH, "ML_BSSN_NoVec_RHS2", 1, 1, 1);
      break;
    }
    
    case 4:
    {
      GenericFD_EnsureStencilFits(cctkGH, "ML_BSSN_NoVec_RHS2", 2, 2, 2);
      break;
    }
    default:
      CCTK_BUILTIN_UNREACHABLE();
