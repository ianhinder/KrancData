...
void CountOperations_TiledLoop(
...
void CountOperations_TiledLoopOverEverything(
  cGH const * restrict const cctkGH,
  void (calc)(const cGH* restrict const cctkGH,
              const KrancData & restrict kd))
{
  ...
  CountOperations_TiledLoop(cctkGH, kd_coarse, calc);
}

void CountOperations_TiledLoopOverInterior(
  cGH const * restrict const cctkGH,
  void (calc)(const cGH* restrict const cctkGH,
              const KrancData & restrict kd))
{
