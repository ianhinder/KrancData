...
extern "C" void IfThen_CheckBoundaries(CCTK_ARGUMENTS)
{
...
extern "C" void IfThen_SelectBoundConds(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
      ...
      CCTK_EQUALS(evolved_group_bound, "zero"  ) )
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "IfThen::evolved_group", evolved_group_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register evolved_group_bound BC for IfThen::evolved_group!");
  }
      ...
      CCTK_EQUALS(phi_bound, "zero"  ) )
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "IfThen::phi", phi_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register phi_bound BC for IfThen::phi!");
  }
      ...
      CCTK_EQUALS(pi_bound, "zero"  ) )
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "IfThen::pi", pi_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register pi_bound BC for IfThen::pi!");
  }
  ...
  if (CCTK_EQUALS(evolved_group_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_evolved_group_bound, 
                      "IfThen::evolved_group", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for IfThen::evolved_group!");
  ...
  if (CCTK_EQUALS(phi_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phi_bound, 
                      "IfThen::phi", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for IfThen::phi!");
  ...
  if (CCTK_EQUALS(pi_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for IfThen::pi!");
  ...
  if (CCTK_EQUALS(evolved_group_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_evolved_group_bound, 
                      "IfThen::evolved_group", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for IfThen::evolved_group!");
  ...
  if (CCTK_EQUALS(phi_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for IfThen::phi!");
  ...
  if (CCTK_EQUALS(pi_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for IfThen::pi!");
...
#$bound$#IfThen::evolved_group_bound       = "skip"
#$bound$#IfThen::evolved_group_bound_speed = 1.0
#$bound$#IfThen::evolved_group_bound_limit = 0.0
#$bound$#IfThen::evolved_group_bound_scalar = 0.0

#$bound$#IfThen::phi_bound       = "skip"
#$bound$#IfThen::phi_bound_speed = 1.0
#$bound$#IfThen::phi_bound_limit = 0.0
#$bound$#IfThen::phi_bound_scalar = 0.0

#$bound$#IfThen::pi_bound       = "skip"
#$bound$#IfThen::pi_bound_speed = 1.0
#$bound$#IfThen::pi_bound_limit = 0.0
#$bound$#IfThen::pi_bound_scalar = 0.0
