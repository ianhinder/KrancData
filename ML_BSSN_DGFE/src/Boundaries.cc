...
extern "C" void ML_BSSN_DGFE_CheckBoundaries(CCTK_ARGUMENTS)
{
...
extern "C" void ML_BSSN_DGFE_SelectBoundConds(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
      ...
      CCTK_EQUALS(ML_log_confac_bound, "zero"  ) )
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::ML_log_confac", ML_log_confac_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register ML_log_confac_bound BC for ML_BSSN_DGFE::ML_log_confac!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::ML_metric", ML_metric_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register ML_metric_bound BC for ML_BSSN_DGFE::ML_metric!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::ML_Gamma", ML_Gamma_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register ML_Gamma_bound BC for ML_BSSN_DGFE::ML_Gamma!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::ML_trace_curv", ML_trace_curv_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register ML_trace_curv_bound BC for ML_BSSN_DGFE::ML_trace_curv!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::ML_curv", ML_curv_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register ML_curv_bound BC for ML_BSSN_DGFE::ML_curv!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::ML_lapse", ML_lapse_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register ML_lapse_bound BC for ML_BSSN_DGFE::ML_lapse!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::ML_dtlapse", ML_dtlapse_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register ML_dtlapse_bound BC for ML_BSSN_DGFE::ML_dtlapse!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::ML_shift", ML_shift_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register ML_shift_bound BC for ML_BSSN_DGFE::ML_shift!");
  }
  ...
  {
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::ML_dtshift", ML_dtshift_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register ML_dtshift_bound BC for ML_BSSN_DGFE::ML_dtshift!");
  }
      ...
      CCTK_EQUALS(phi_bound, "zero"  ) )
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::phi", phi_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register phi_bound BC for ML_BSSN_DGFE::phi!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::gt11", gt11_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register gt11_bound BC for ML_BSSN_DGFE::gt11!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::gt12", gt12_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register gt12_bound BC for ML_BSSN_DGFE::gt12!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::gt13", gt13_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register gt13_bound BC for ML_BSSN_DGFE::gt13!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::gt22", gt22_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register gt22_bound BC for ML_BSSN_DGFE::gt22!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::gt23", gt23_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register gt23_bound BC for ML_BSSN_DGFE::gt23!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::gt33", gt33_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register gt33_bound BC for ML_BSSN_DGFE::gt33!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::Xt1", Xt1_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Xt1_bound BC for ML_BSSN_DGFE::Xt1!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::Xt2", Xt2_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Xt2_bound BC for ML_BSSN_DGFE::Xt2!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::Xt3", Xt3_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Xt3_bound BC for ML_BSSN_DGFE::Xt3!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::trK", trK_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register trK_bound BC for ML_BSSN_DGFE::trK!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::At11", At11_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register At11_bound BC for ML_BSSN_DGFE::At11!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::At12", At12_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register At12_bound BC for ML_BSSN_DGFE::At12!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::At13", At13_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register At13_bound BC for ML_BSSN_DGFE::At13!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::At22", At22_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register At22_bound BC for ML_BSSN_DGFE::At22!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::At23", At23_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register At23_bound BC for ML_BSSN_DGFE::At23!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::At33", At33_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register At33_bound BC for ML_BSSN_DGFE::At33!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::alpha", alpha_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register alpha_bound BC for ML_BSSN_DGFE::alpha!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::A", A_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register A_bound BC for ML_BSSN_DGFE::A!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::beta1", beta1_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register beta1_bound BC for ML_BSSN_DGFE::beta1!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::beta2", beta2_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register beta2_bound BC for ML_BSSN_DGFE::beta2!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::beta3", beta3_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register beta3_bound BC for ML_BSSN_DGFE::beta3!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::B1", B1_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register B1_bound BC for ML_BSSN_DGFE::B1!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::B2", B2_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register B2_bound BC for ML_BSSN_DGFE::B2!");
  }
  ...
  {
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_DGFE::B3", B3_bound);
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register B3_bound BC for ML_BSSN_DGFE::B3!");
  }
  ...
  if (CCTK_EQUALS(ML_log_confac_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_log_confac_bound, 
                      "ML_BSSN_DGFE::ML_log_confac", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::ML_log_confac!");
  ...
  if (CCTK_EQUALS(ML_metric_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_metric_bound, 
                      "ML_BSSN_DGFE::ML_metric", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::ML_metric!");
  ...
  if (CCTK_EQUALS(ML_Gamma_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_Gamma_bound, 
                      "ML_BSSN_DGFE::ML_Gamma", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::ML_Gamma!");
  ...
  if (CCTK_EQUALS(ML_trace_curv_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_trace_curv_bound, 
                      "ML_BSSN_DGFE::ML_trace_curv", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::ML_trace_curv!");
  ...
  if (CCTK_EQUALS(ML_curv_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_curv_bound, 
                      "ML_BSSN_DGFE::ML_curv", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::ML_curv!");
  ...
  if (CCTK_EQUALS(ML_lapse_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_lapse_bound, 
                      "ML_BSSN_DGFE::ML_lapse", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::ML_lapse!");
  ...
  if (CCTK_EQUALS(ML_dtlapse_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_dtlapse_bound, 
                      "ML_BSSN_DGFE::ML_dtlapse", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::ML_dtlapse!");
  ...
  if (CCTK_EQUALS(ML_shift_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_shift_bound, 
                      "ML_BSSN_DGFE::ML_shift", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::ML_shift!");
  ...
  if (CCTK_EQUALS(ML_dtshift_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_dtshift_bound, 
                      "ML_BSSN_DGFE::ML_dtshift", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::ML_dtshift!");
  ...
  if (CCTK_EQUALS(phi_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phi_bound, 
                      "ML_BSSN_DGFE::phi", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::phi!");
  ...
  if (CCTK_EQUALS(gt11_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt11_bound, 
                      "ML_BSSN_DGFE::gt11", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::gt11!");
  ...
  if (CCTK_EQUALS(gt12_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt12_bound, 
                      "ML_BSSN_DGFE::gt12", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::gt12!");
  ...
  if (CCTK_EQUALS(gt13_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt13_bound, 
                      "ML_BSSN_DGFE::gt13", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::gt13!");
  ...
  if (CCTK_EQUALS(gt22_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt22_bound, 
                      "ML_BSSN_DGFE::gt22", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::gt22!");
  ...
  if (CCTK_EQUALS(gt23_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt23_bound, 
                      "ML_BSSN_DGFE::gt23", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::gt23!");
  ...
  if (CCTK_EQUALS(gt33_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt33_bound, 
                      "ML_BSSN_DGFE::gt33", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::gt33!");
  ...
  if (CCTK_EQUALS(Xt1_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Xt1_bound, 
                      "ML_BSSN_DGFE::Xt1", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::Xt1!");
  ...
  if (CCTK_EQUALS(Xt2_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Xt2_bound, 
                      "ML_BSSN_DGFE::Xt2", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::Xt2!");
  ...
  if (CCTK_EQUALS(Xt3_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Xt3_bound, 
                      "ML_BSSN_DGFE::Xt3", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::Xt3!");
  ...
  if (CCTK_EQUALS(trK_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_trK_bound, 
                      "ML_BSSN_DGFE::trK", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::trK!");
  ...
  if (CCTK_EQUALS(At11_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At11_bound, 
                      "ML_BSSN_DGFE::At11", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::At11!");
  ...
  if (CCTK_EQUALS(At12_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At12_bound, 
                      "ML_BSSN_DGFE::At12", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::At12!");
  ...
  if (CCTK_EQUALS(At13_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At13_bound, 
                      "ML_BSSN_DGFE::At13", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::At13!");
  ...
  if (CCTK_EQUALS(At22_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At22_bound, 
                      "ML_BSSN_DGFE::At22", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::At22!");
  ...
  if (CCTK_EQUALS(At23_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At23_bound, 
                      "ML_BSSN_DGFE::At23", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::At23!");
  ...
  if (CCTK_EQUALS(At33_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At33_bound, 
                      "ML_BSSN_DGFE::At33", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::At33!");
  ...
  if (CCTK_EQUALS(alpha_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_alpha_bound, 
                      "ML_BSSN_DGFE::alpha", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::alpha!");
  ...
  if (CCTK_EQUALS(A_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A_bound, 
                      "ML_BSSN_DGFE::A", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::A!");
  ...
  if (CCTK_EQUALS(beta1_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta1_bound, 
                      "ML_BSSN_DGFE::beta1", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::beta1!");
  ...
  if (CCTK_EQUALS(beta2_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta2_bound, 
                      "ML_BSSN_DGFE::beta2", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::beta2!");
  ...
  if (CCTK_EQUALS(beta3_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta3_bound, 
                      "ML_BSSN_DGFE::beta3", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::beta3!");
  ...
  if (CCTK_EQUALS(B1_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_B1_bound, 
                      "ML_BSSN_DGFE::B1", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::B1!");
  ...
  if (CCTK_EQUALS(B2_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_B2_bound, 
                      "ML_BSSN_DGFE::B2", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::B2!");
  ...
  if (CCTK_EQUALS(B3_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_B3_bound, 
                      "ML_BSSN_DGFE::B3", "Radiation");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Radiation BC for ML_BSSN_DGFE::B3!");
  ...
  if (CCTK_EQUALS(ML_log_confac_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_log_confac_bound, 
                      "ML_BSSN_DGFE::ML_log_confac", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for ML_BSSN_DGFE::ML_log_confac!");
  ...
  if (CCTK_EQUALS(ML_metric_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_metric_bound, 
                      "ML_BSSN_DGFE::ML_metric", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for ML_BSSN_DGFE::ML_metric!");
  ...
  if (CCTK_EQUALS(ML_Gamma_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_Gamma_bound, 
                      "ML_BSSN_DGFE::ML_Gamma", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for ML_BSSN_DGFE::ML_Gamma!");
  ...
  if (CCTK_EQUALS(ML_trace_curv_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_trace_curv_bound, 
                      "ML_BSSN_DGFE::ML_trace_curv", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for ML_BSSN_DGFE::ML_trace_curv!");
  ...
  if (CCTK_EQUALS(ML_curv_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_curv_bound, 
                      "ML_BSSN_DGFE::ML_curv", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for ML_BSSN_DGFE::ML_curv!");
  ...
  if (CCTK_EQUALS(ML_lapse_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_lapse_bound, 
                      "ML_BSSN_DGFE::ML_lapse", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for ML_BSSN_DGFE::ML_lapse!");
  ...
  if (CCTK_EQUALS(ML_dtlapse_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_dtlapse_bound, 
                      "ML_BSSN_DGFE::ML_dtlapse", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for ML_BSSN_DGFE::ML_dtlapse!");
  ...
  if (CCTK_EQUALS(ML_shift_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_shift_bound, 
                      "ML_BSSN_DGFE::ML_shift", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for ML_BSSN_DGFE::ML_shift!");
  ...
  if (CCTK_EQUALS(ML_dtshift_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_dtshift_bound, 
                      "ML_BSSN_DGFE::ML_dtshift", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Failed to register Scalar BC for ML_BSSN_DGFE::ML_dtshift!");
  ...
  if (CCTK_EQUALS(phi_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phi_bound, 
                      "ML_BSSN_DGFE::phi", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::phi!");
  ...
  if (CCTK_EQUALS(gt11_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt11_bound, 
                      "ML_BSSN_DGFE::gt11", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::gt11!");
  ...
  if (CCTK_EQUALS(gt12_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt12_bound, 
                      "ML_BSSN_DGFE::gt12", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::gt12!");
  ...
  if (CCTK_EQUALS(gt13_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt13_bound, 
                      "ML_BSSN_DGFE::gt13", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::gt13!");
  ...
  if (CCTK_EQUALS(gt22_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt22_bound, 
                      "ML_BSSN_DGFE::gt22", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::gt22!");
  ...
  if (CCTK_EQUALS(gt23_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt23_bound, 
                      "ML_BSSN_DGFE::gt23", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::gt23!");
  ...
  if (CCTK_EQUALS(gt33_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt33_bound, 
                      "ML_BSSN_DGFE::gt33", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::gt33!");
  ...
  if (CCTK_EQUALS(Xt1_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Xt1_bound, 
                      "ML_BSSN_DGFE::Xt1", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::Xt1!");
  ...
  if (CCTK_EQUALS(Xt2_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Xt2_bound, 
                      "ML_BSSN_DGFE::Xt2", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::Xt2!");
  ...
  if (CCTK_EQUALS(Xt3_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Xt3_bound, 
                      "ML_BSSN_DGFE::Xt3", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::Xt3!");
  ...
  if (CCTK_EQUALS(trK_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_trK_bound, 
                      "ML_BSSN_DGFE::trK", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::trK!");
  ...
  if (CCTK_EQUALS(At11_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At11_bound, 
                      "ML_BSSN_DGFE::At11", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::At11!");
  ...
  if (CCTK_EQUALS(At12_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At12_bound, 
                      "ML_BSSN_DGFE::At12", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::At12!");
  ...
  if (CCTK_EQUALS(At13_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At13_bound, 
                      "ML_BSSN_DGFE::At13", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::At13!");
  ...
  if (CCTK_EQUALS(At22_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At22_bound, 
                      "ML_BSSN_DGFE::At22", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::At22!");
  ...
  if (CCTK_EQUALS(At23_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At23_bound, 
                      "ML_BSSN_DGFE::At23", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::At23!");
  ...
  if (CCTK_EQUALS(At33_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At33_bound, 
                      "ML_BSSN_DGFE::At33", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::At33!");
  ...
  if (CCTK_EQUALS(alpha_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_alpha_bound, 
                      "ML_BSSN_DGFE::alpha", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::alpha!");
  ...
  if (CCTK_EQUALS(A_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_A_bound, 
                      "ML_BSSN_DGFE::A", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::A!");
  ...
  if (CCTK_EQUALS(beta1_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta1_bound, 
                      "ML_BSSN_DGFE::beta1", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::beta1!");
  ...
  if (CCTK_EQUALS(beta2_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta2_bound, 
                      "ML_BSSN_DGFE::beta2", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::beta2!");
  ...
  if (CCTK_EQUALS(beta3_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta3_bound, 
                      "ML_BSSN_DGFE::beta3", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::beta3!");
  ...
  if (CCTK_EQUALS(B1_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_B1_bound, 
                      "ML_BSSN_DGFE::B1", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::B1!");
  ...
  if (CCTK_EQUALS(B2_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_B2_bound, 
                      "ML_BSSN_DGFE::B2", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::B2!");
  ...
  if (CCTK_EQUALS(B3_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = Boundary_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_B3_bound, 
                      "ML_BSSN_DGFE::B3", "scalar");
  
    if (ierr < 0)
       CCTK_WARN(0, "Error in registering Scalar BC for ML_BSSN_DGFE::B3!");
...
#$bound$#ML_BSSN_DGFE::ML_log_confac_bound       = "skip"
#$bound$#ML_BSSN_DGFE::ML_log_confac_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::ML_log_confac_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::ML_log_confac_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::ML_metric_bound       = "skip"
#$bound$#ML_BSSN_DGFE::ML_metric_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::ML_metric_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::ML_metric_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::ML_Gamma_bound       = "skip"
#$bound$#ML_BSSN_DGFE::ML_Gamma_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::ML_Gamma_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::ML_Gamma_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::ML_trace_curv_bound       = "skip"
#$bound$#ML_BSSN_DGFE::ML_trace_curv_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::ML_trace_curv_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::ML_trace_curv_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::ML_curv_bound       = "skip"
#$bound$#ML_BSSN_DGFE::ML_curv_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::ML_curv_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::ML_curv_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::ML_lapse_bound       = "skip"
#$bound$#ML_BSSN_DGFE::ML_lapse_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::ML_lapse_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::ML_lapse_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::ML_dtlapse_bound       = "skip"
#$bound$#ML_BSSN_DGFE::ML_dtlapse_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::ML_dtlapse_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::ML_dtlapse_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::ML_shift_bound       = "skip"
#$bound$#ML_BSSN_DGFE::ML_shift_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::ML_shift_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::ML_shift_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::ML_dtshift_bound       = "skip"
#$bound$#ML_BSSN_DGFE::ML_dtshift_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::ML_dtshift_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::ML_dtshift_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::phi_bound       = "skip"
#$bound$#ML_BSSN_DGFE::phi_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::phi_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::phi_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::gt11_bound       = "skip"
#$bound$#ML_BSSN_DGFE::gt11_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::gt11_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::gt11_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::gt12_bound       = "skip"
#$bound$#ML_BSSN_DGFE::gt12_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::gt12_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::gt12_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::gt13_bound       = "skip"
#$bound$#ML_BSSN_DGFE::gt13_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::gt13_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::gt13_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::gt22_bound       = "skip"
#$bound$#ML_BSSN_DGFE::gt22_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::gt22_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::gt22_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::gt23_bound       = "skip"
#$bound$#ML_BSSN_DGFE::gt23_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::gt23_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::gt23_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::gt33_bound       = "skip"
#$bound$#ML_BSSN_DGFE::gt33_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::gt33_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::gt33_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::Xt1_bound       = "skip"
#$bound$#ML_BSSN_DGFE::Xt1_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::Xt1_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::Xt1_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::Xt2_bound       = "skip"
#$bound$#ML_BSSN_DGFE::Xt2_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::Xt2_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::Xt2_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::Xt3_bound       = "skip"
#$bound$#ML_BSSN_DGFE::Xt3_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::Xt3_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::Xt3_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::trK_bound       = "skip"
#$bound$#ML_BSSN_DGFE::trK_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::trK_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::trK_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::At11_bound       = "skip"
#$bound$#ML_BSSN_DGFE::At11_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::At11_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::At11_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::At12_bound       = "skip"
#$bound$#ML_BSSN_DGFE::At12_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::At12_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::At12_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::At13_bound       = "skip"
#$bound$#ML_BSSN_DGFE::At13_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::At13_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::At13_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::At22_bound       = "skip"
#$bound$#ML_BSSN_DGFE::At22_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::At22_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::At22_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::At23_bound       = "skip"
#$bound$#ML_BSSN_DGFE::At23_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::At23_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::At23_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::At33_bound       = "skip"
#$bound$#ML_BSSN_DGFE::At33_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::At33_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::At33_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::alpha_bound       = "skip"
#$bound$#ML_BSSN_DGFE::alpha_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::alpha_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::alpha_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::A_bound       = "skip"
#$bound$#ML_BSSN_DGFE::A_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::A_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::A_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::beta1_bound       = "skip"
#$bound$#ML_BSSN_DGFE::beta1_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::beta1_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::beta1_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::beta2_bound       = "skip"
#$bound$#ML_BSSN_DGFE::beta2_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::beta2_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::beta2_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::beta3_bound       = "skip"
#$bound$#ML_BSSN_DGFE::beta3_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::beta3_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::beta3_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::B1_bound       = "skip"
#$bound$#ML_BSSN_DGFE::B1_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::B1_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::B1_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::B2_bound       = "skip"
#$bound$#ML_BSSN_DGFE::B2_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::B2_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::B2_bound_scalar = 0.0

#$bound$#ML_BSSN_DGFE::B3_bound       = "skip"
#$bound$#ML_BSSN_DGFE::B3_bound_speed = 1.0
#$bound$#ML_BSSN_DGFE::B3_bound_limit = 0.0
#$bound$#ML_BSSN_DGFE::B3_bound_scalar = 0.0
